...
const username = "coopersmith"; // Replace with your Last.fm username
  ...
  // API Endpoint to get top artists
const apiUrl = `http://ws.audioscrobbler.com/2.0/?method=user.gettopartists&user=${username}&api_key=${apiKey}&format=json&period=3month&limit=5`;
